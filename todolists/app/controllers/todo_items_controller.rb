class TodoItemsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @todo_item.save
        format.html { redirect_to @todo_list, notice: 'To do item was successfully created.' }
  ...
  def destroy
    @todo_item.destroy
    respond_to do |format|
      format.html { redirect_to todo_list, notice: 'To do item was successfully destroyed.' }
